...
public class RateUs extends AppCompatActivity
    ...
    private void openFeedback() {
        ...
        email.putExtra(Intent.EXTRA_SUBJECT, "[MuetOnlineDocumentVerification] Feedback");
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.home:
                Intent s= new Intent(RateUs.this,Home.class);
                startActivity(s);
            ...
            case R.id.rate_us:
                ...
                break;
            case R.id.about:
                Intent v= new Intent(RateUs.this,About.class);
                startActivity(v);

                break;
            case R.id.terms_and_conditions:
                Intent w= new Intent(RateUs.this,TermsAndConditions.class);
                startActivity(w);

                break;
            case R.id.action_settings:
                Intent x= new Intent(RateUs.this,Settings.class);
                startActivity(x);
