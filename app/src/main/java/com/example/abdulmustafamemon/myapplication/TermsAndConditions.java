...
public class TermsAndConditions extends AppCompatActivity
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.home:
                Intent s= new Intent(TermsAndConditions.this,Home.class);
                startActivity(s);
            ...
            case R.id.rate_us:
                ...
                break;
            case R.id.about:
                Intent v= new Intent(TermsAndConditions.this,About.class);
                startActivity(v);

                break;
            case R.id.terms_and_conditions:
                Intent w= new Intent(TermsAndConditions.this,TermsAndConditions.class);
                startActivity(w);

                break;
            case R.id.action_settings:
                Intent x= new Intent(TermsAndConditions.this,Settings.class);
                startActivity(x);
